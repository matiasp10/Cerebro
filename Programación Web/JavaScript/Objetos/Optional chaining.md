El encadenamiento opcional `?.` es una _forma a prueba de errores para acceder a las propiedades anidadas de los objetos_, incluso si no existe una propiedad intermedia.
